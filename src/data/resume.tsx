...
export const DATA = {
  ...
  locationLink: "https://www.google.com/maps/place/Calicut",
  description:
    "Designing and developing aesthetic web & app experiences with clean code",
  summary:
    "I’m Ajmal Ameen, a web and app developer based in Calicut, specializing in e-commerce development and modern user experiences. I focus on building customized interfaces, implementing innovative solutions, and creating seamless digital products through effective collaboration with designers and project managers.",
  avatarUrl: "/me.png",
  skills: [
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/ajmaloffical04-design",
        icon: Icons.github,
        navbar: true,
      },
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ajmlameen/",
        icon: Icons.linkedin,
  ...
  work: [
    {
      ...
      badges: [],
      location: "Calicut",
      title: "UI/UX & Web and App Developer",
      logoUrl: "/kitemedia.png",
      start: "April 2024",
      end: "Present",
      description:
        "",
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "I developed and launched Uventer, a localized event platform focused on corporate events and collaborative ticket booking experiences. The app helps organizers manage events efficiently while providing users with a seamless booking experience.",
      technologies: [
        "Flutter",
        "Next.js",
        "TailwindCSS",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/Kitemediaconcept-code/uventer",
    ...
    },
    {
      ...
      active: true,
      description:
        "A comprehensive healthcare website providing medical services information, doctor appointments, and patient care details.",
      technologies: [
        "WordPress",
        "Elementor",
        "PHP",
    ...
    },
    {
      ...
      active: true,
      description:
        "A clothing brand e-commerce platform featuring modern aesthetics and a smooth shopping experience.",
      technologies: [
        "Next.js",
        "TailwindCSS",
        "CMS",
    ...
    },
    {
      ...
      active: true,
      description:
        "USA-based diamond jewellery e-commerce project with an elegant design and custom shopping features.",
      technologies: [
        "Shopify CMS",
        "HTML",
        "CSS",
